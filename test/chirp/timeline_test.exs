defmodule Chirp.TimelineTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", likes_count: "some likes_count", reposts_count: "some reposts_count", username: "some username"}
    ...
    test "create_post/1 with valid data creates a post" do
      ...
      assert post.reposts_count == "some reposts_count"
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert post.reposts_count == "some updated reposts_count"
